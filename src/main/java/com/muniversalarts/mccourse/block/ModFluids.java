...
public class ModFluids {
    ...
    public static final ForgeFlowingFluid.Properties OIL_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            density(15).luminosity(2).rarity(Rarity.RARE).sound(SoundEvents.ITEM_HONEY_BOTTLE_DRINK).
            overlay(OIL_OVERLAY_RL).viscosity(5)).slopeFindDistance(3).levelDecreasePerBlock(3).
