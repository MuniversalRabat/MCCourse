package com.muniversalarts.mccourse.entity.model;
...
public class BuffaloModel<T extends BuffaloEntity> extends EntityModel<T> {
    ...
    public BuffaloModel() {
        ...
        body.setTextureOffset(0, 28).addBox(-5.0F, -7.5F, -4.5F, 10.0F, 7.0F, 10.0F, 0.0F, false);
        body.setTextureOffset(30, 10).addBox(-4.0F, -5.5F, -3.5F, 8.0F, 12.0F, 8.0F, 0.0F, false);
        ...
        legBackRight.setTextureOffset(63, 31).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, 0.0F, false);

        legBackLeft = new ModelRenderer(this);
        legBackLeft.setRotationPoint(3.0F, 11.0F, 7.0F);
        legBackLeft.setTextureOffset(63, 31).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, 0.0F, false);
    }
