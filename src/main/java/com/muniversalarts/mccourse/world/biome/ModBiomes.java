package com.muniversalarts.mccourse.world.biome;

import com.muniversalarts.mccourse.util.Registration;
import com.muniversalarts.mccourse.world.feature.ModConfiguredFeatures;
    ...
    private static Biome makeOilBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale){
        ...
        return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.SWAMP).
                ...
                setEffects((new BiomeAmbience.Builder()).setWaterColor(6388580).setWaterFogColor(2302743).
                        setFogColor(12638463).withSkyColor(getSkyColorWithTemperatureModifier(0.8F)).
